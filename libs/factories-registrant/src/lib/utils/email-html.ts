...
export const htmlForEmail = (data: FactoryCreationDTO): string => {
    ...
    <ul>
      ...
      <li>Organization Type: <b>${data.type}</b></li>
      <li>Organization Domain: <b>${data.domain}</b></li>
      <li>Organization Country: <b>${data.country}</b></li>
      <li>Organization Size: <b>${data.size}</b></li>
